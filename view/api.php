			...
			if ($_SERVER["REQUEST_METHOD"] === 'POST') {
				if ($_POST["cmd"] > '0' && $_POST["cmd"] < '89' && $_POST["cmd1"] > '0' && $_POST["cmd1"] < '62') {
					...
					$json_data = json_decode($json, true);
						...
						echo "<br>";
						echo "<pre>";
					  	echo "Nome: ". "<h2 style='color:white; margin-bottom: 0px;'>".$json_data["name"]."</h2>". "<i style='color: white; font-size: 13px;'><b>Altura</b>: ".$json_data["height"]. " cm</i> | " . "<i style='color: white; font-size: 13px;'><b>Peso</b>: ".$json_data["mass"]." km</i>";
						echo "</pre>";
					...
					$json_data1 = json_decode($json1, true);
						echo "<pre>";
						echo "Destino: "."<h3 style='color:white; margin-bottom: 0px;'>". $json_data1["name"]. "</h3>". "<i style='color: white; font-size: 13px;'><b>Diâmetro</b>: ".$json_data1["diameter"]. " km</i> | " . "<i style='color: white; font-size: 13px;'><b>Clima</b>: ".$json_data1["climate"]."</i>";
						echo "</pre>";
				}
